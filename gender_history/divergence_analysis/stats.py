# Copied from https://github.com/srisi/tobacco_litigation/blob/master/tobacco_litigation/stats.py
# for easier import
        ...
        for i, token in enumerate(self.vocabulary):
            ...
            for correlated_token_id in most_correlated_tokens:
                ...
                # skip he, she, s/he
                    ...
                    correlation_result.append('({}: {:4.2f})'.format(correlated_token, correlation))
