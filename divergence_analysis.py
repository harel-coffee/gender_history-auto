...
def divergence_analysis(master_dataset:Dataset,
    ...
    if not c1_name:
        c1_name = sub_corpus_1.name
    if not c2_name:
        c2_name = sub_corpus_2.name
    ...
    if topics_or_terms == 'terms':
        ...
        master_dtm = master_dataset.get_document_topic_matrix() * 300
        c1_dtm = sub_corpus_1.get_document_topic_matrix() * 300
        c2_dtm = sub_corpus_2.get_document_topic_matrix() * 300
    ...
    for term_idx in range(len(vocabulary)):
        ...
        data.append({
            ...
            f'frequency_{c2_name}': count_c2 / total_terms_c2,
